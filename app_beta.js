document.addEventListener('DOMContentLoaded', () => {
    ...
    // Word Document (.docx) Export Listener (Beta)
    ...
    if (btnExportDocx) {
        btnExportDocx.addEventListener('click', () => {
            ...
            // Clone the container to manipulate it without affecting preview
            const clone = container.cloneNode(true);
            
            // Remove page number footers in Word export if they shouldn't be hardcoded text
            ...
            // Add custom Word page setup styles (portrait A4, standard margin 2.3cm)
            const wordStyles = `
                @page Section1 {
                    size: 210mm 297mm;
                    margin: 2.3cm 2.3cm 2.3cm 2.3cm;
            ...
            // Convert to DOCX Blob and download
            ...
            const templateName = templateSelect.value === 'upward' ? '上行文' : '平行文_下行文';
            
            saveAs(blob, `長庚大學公文_${templateName}_${dateStr}.docx`);
        });
    }
